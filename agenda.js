...
[ // The progam is an array of weeks.
  ...
  [
    ...
    { date: "Wednesday Sept 15th",
      ...
      title: "[chapter 10 – more about functions: _local variables_ and _side effects_](/ch10-locals-and-side-effects/index.html), and chapter [chapter 11 – fun with data types](/ch11-fun-with-datatypes/index.html)",
      content: [
  ...
  [
    { date: "Tuesday Sept 21st",
      title: "[chapter 12 – recap: let&apos;s review what you&apos;ve learned by now](/ch12-recap/index.html)",
      content: [
    ...
    { date: "Thursday Sept 23rd",
      title: "[chapter 13 – loops for repeating commands _(continued)_](/ch13-loops/index.html)",
      content: [
